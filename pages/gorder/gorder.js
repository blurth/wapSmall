...
Page({
  ...
  * */
  onLoad: function (options) {
    ...
    var fromPtFlag = options.from == 'goods';
  ...
  onShow: function () {
    if (this.data.id) {
      ...
      var id = this.data.id;
      gorder.getOrderInfoById(id, (data) => {
        that.setData({
